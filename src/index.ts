// UI
let outputScreen: HTMLSpanElement | null = null;
let outputOperation: HTMLSpanElement | null = null;
let otputMemory: HTMLSpanElement | null = null;
...
type SingleCalculation = { A: string, operation: string, B: string, equalsProc: boolean }
